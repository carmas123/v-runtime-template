...
export default {
  ...
  render(h) {
    if (this.template) {
      ...
      Object.keys(computed).forEach(e => {if(typeof this.$options.computed==="undefined" || typeof this.$options.computed[e]==="undefined") passthrough.computed[e] = computed[e];} );
      Object.keys(components).forEach(e => {if(typeof this.$options.components==="undefined" || typeof this.$options.components[e]==="undefined") passthrough.components[e] = components[e];} );
