...
var index = {
  ...
  render: function render(h) {
    ...
    if (this.template) {
      ...
      Object.keys(methods).forEach(function (e) {if(typeof this$1.$options.methods==="undefined" || typeof this$1.$options.methods[e]==="undefined") { passthrough.methods[e] = methods[e]; }} );
      Object.keys(computed).forEach(function (e) {if(typeof this$1.$options.computed==="undefined" || typeof this$1.$options.computed[e]==="undefined") { passthrough.computed[e] = computed[e]; }} );
      Object.keys(components).forEach(function (e) {if(typeof this$1.$options.components==="undefined" || typeof this$1.$options.components[e]==="undefined") { passthrough.components[e] = components[e]; }} );
